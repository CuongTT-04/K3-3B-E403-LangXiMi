...
- [ ] Chuẩn bị nộp CP5: slide PDF, video demo dự phòng.
...
- [ ] Cơ chế lưu lịch sử lỗi sai vào Knowledge Graph cá nhân dài hạn và thuật toán lặp lại ngắt quãng (Spaced Repetition).
...
- [x] **CP4 — AI Spec & quality bar** (18/09/2026): hoàn thiện `spec.md` §1–§9 và khóa `P≥16/20 ∧ invalid citation=0 ∧ outside-scope safe=100%`. Golden set hiện có 20 case; MockLLM đo 20/20, provider thật đo 18/20 vì HTTP 429 ở q08. Tự khai: chưa chấm đầy đủ D1–D4 ngữ nghĩa/tone.
- [x] **CP5 — User Validation (19/09/2026):** Hoàn tất vòng thử nghiệm người dùng ngoài nhóm (5/5 người, gồm 3 willing users CP1 Văn Quốc Dũng, Nguyễn Đức Thịnh, Lương Sỹ Khánh) tại `validation/user-validation-template.md`.
